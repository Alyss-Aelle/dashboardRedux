...
const NavGauche = () => {
  return (
<aside className="ml-[-100%] fixed z-10 top-2  pb-3 px-6 w-full flex flex-col justify-between h-screen rounded-xl bg-gradient-to-r from-blue-400	 to-violet-400 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
    <div>
        ...
        <ul className="space-y-2 tracking-wide mt-8">
            <li>
                <Link to="/" aria-label="dashboard" className="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white ">
            ...
            <li>
                <Link to="/category" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 hover:text-violet-600	">
            ...
            <li>
                <Link to="/question"  className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 hover:text-violet-600	">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li>
                <Link to="/action" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600  hover:text-violet-600	">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <span className="group-hover:text-gray-700">Actions</span>
                </Link>
            </li>
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span className="group-hover:text-gray-700">Another</span>
                </a>
            </li>
        </ul>
    </div>
